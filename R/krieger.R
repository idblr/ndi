...
#' \item{\code{missing}}{An object of class 'tbl' of the count and proportion of missingness for each census variable used to compute the ICEs.}
#' }
#' 
#' @import dplyr
...
#' }
#' 
krieger <- function(geo = "tract", year = 2020, quiet = FALSE, ...) {
  ...
  ice_vars <- ice_vars %>% 
    dplyr::mutate(county = stringr::str_trim(county),
                  ...
                  P_edu = O25MNSC + O25FNSC + O25MNt4G + O25FNt4G +
                          ...
                          O25M9G + O25F9G + O25M10G + O25F10G +
                          O25M11G + O25F11G + O25M12GND + O25F12GND)
  ...
  missingYN <- ice_vars %>% 
    dplyr::select(U10i, B1015i, B1520i, B2025i, B2530i, B100125i, B125150i, 
                  ...
                  O25M10G, O25F10G, O25M11G, O25F11G, O25M12GND, O25F12GND,
                  O25MBD, O25FBD, O25MMD, O25FMD, O25MPSD, O25FPSD, O25MDD,
                  O25FDD, NHoLW, NHoLB, U10nhw, B1015nhw, B1520nhw, 
                  B2025nhw, B2530nhw, B100125nhw, B125150nhw, 
