...
#' 
#' \code{\link{white}} Computes the aspatial racial/ethnic Correlation Ratio (V) based on based on Bell (1954) \doi{10.2307/2574118} and White (1986) \doi{10.2307/3644339}.
#' 
