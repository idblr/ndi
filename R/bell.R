...
#'   bell(geo_large = "county", geo_small = "tract", state = "GA", year = 2020,
#'        subgroup = "NHoLB", subgroup_ixn = "NHoLW")
#'   
#' }
#' 
bell <- function(geo_large = "county", geo_small = "tract", year = 2020, subgroup, subgroup_ixn, omit_NAs = TRUE, quiet = FALSE, ...) {
  ...
  missingYN <- ii_vars[ , c("TotalPopE", in_subgroup, in_subgroup_ixn)]
