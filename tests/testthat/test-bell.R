...
test_that("bell throws error with invalid arguments", {
  ...
  expect_error(bell(geo_small = "zcta", state = "DC", year = 2020,
                    subgroup = "NHoLB", subgroup_ixn = "NHoLW", quiet = TRUE))
  expect_error(bell(geo_large = "block group", state = "DC", year = 2020,
                    subgroup = "NHoLB", subgroup_ixn = "NHoLW", quiet = TRUE))
  
  # Unavailable year
  expect_error(bell(state = "DC", year = 2005,
                    subgroup = "NHoLB", subgroup_ixn = "NHoLW", quiet = TRUE))
  
  # Unavailable subgroup
  expect_error(bell(state = "DC", year = 2020,
  ...
  # Incorrect state
  expect_error(bell(state = "AB", year = 2020,
                    subgroup = "NHoLB", subgroup_ixn = "NHoLW", quiet = TRUE))
...
test_that("bell works", {  
  ...
  expect_silent(bell(state = "DC", year = 2020,
