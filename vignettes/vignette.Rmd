...
Compute the DI (Duncan) values (2006-2010 5-year ACS) for Pennsylvania, U.S.A., counties. This metric is based on [Duncan & Duncan (1955)](https://doi.org/10.2307/2088328) that assessed the racial/ethnic isolation of students that identify as non-Hispanic or Latino, Black or African American alone compared to students that identify as non-Hispanic or Latino, white alone between schools and school districts. Multiple racial/ethnic subgroups are available in the `duncan()` function, including:
...
```{r duncan, fig.height=4, fig.width=7}
...
# Visualize the DI (Duncan) values (2006-2010 5-year ACS) for PAorida, U.S.A., census tracts 
ggplot2::ggplot() + 
