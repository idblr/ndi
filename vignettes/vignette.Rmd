...
5. `duncan()` function that computes the Dissimilarity Index based on [Duncan & Duncan (1955)](https://doi.org/10.2307/2088328)
6. `atkinson()` function that computes the Atkinson Index based on [Atkinson (1970)](https://doi.org/10.1016/0022-0531(70)90039-6)
