...
We can visualize the *NDI* (Messer) values geographically by linking them to spatial information from the [*tigris*](https://CRAN.R-project.org/package=tigris) package and plotting with the [*ggplot2*](https://CRAN.R-project.org/package=ggplot2) package suite.
...
We can visualize the *NDI* (Powell-Wiley) values geographically by linking them to spatial information from the [*tigris*](https://CRAN.R-project.org/package=tigris) package and plotting with the [*ggplot2*](https://CRAN.R-project.org/package=ggplot2) package suite.
